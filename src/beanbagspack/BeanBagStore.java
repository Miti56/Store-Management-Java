...
/**
 * beanbagspack.BeanBagStore interface. The no-argument constructor of a class
 * implementing this interface should initialise the beanbagspack.BeanBagStore
...
public interface BeanBagStore
{
     ...
     * <p>
     * The state of this beanbagspack.BeanBagStore must be be unchanged if any exceptions are
     * thrown.
     *
    ...
    /**
     * Access method for the number of BeanBags stocked by this beanbagspack.BeanBagStore
    ...
    /**
     * Method saves this beanbagspack.BeanBagStore's contents into a serialised file,
    ...
    /**
     * Method should load and replace this beanbagspack.BeanBagStore's contents with the
    ...
    /**
     * Method to return number of bean bags sold by this beanbagspack.BeanBagStore.
     *
    ...
    /**
     * Method to return number of bean bags sold by this beanbagspack.BeanBagStore with
     * matching ID.
     * <p>
     * The state of this beanbagspack.BeanBagStore must be be unchanged if any exceptions are
     * thrown.
    ...
    /**
     * Method to return total price of bean bags sold by this beanbagspack.BeanBagStore
    ...
    /**
     * Method to return the total price of reserved bean bags in this beanbagspack.BeanBagStore
    ...
    /**
     * Method empties this beanbagspack.BeanBagStore of its contents and resets
     ...
     * The stock levels of this beanbagspack.BeanBagStore and reservations should
     * be unaffected.
     */
